...
public class PrintHelper {
	...
	public static void printSingle(String name, int num, int sex, String hospital, String uuid) {
		System.setProperty("jna.encoding", "GBK");
		Printer.Command.Start();
		Printer.Command.PrintText_EZPL_Internal("Z1", 10, 15, 2, 2, 0, "0", hospital);
		...
		Printer.Command.PrintText_EZPL_Internal("Z1", 180, 200, 2, 2, 0, "0", uuid);
