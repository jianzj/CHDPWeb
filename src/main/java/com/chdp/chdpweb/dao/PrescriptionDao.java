...
public interface PrescriptionDao {
	...
	int countPrsNumForHospital(@Param("hospital") String hospital, @Param("process") int process, @Param("start") String start, @Param("end") String end);
    ...
    @Update("update prescription set class_of_medicines = #{prs.class_of_medicines}, process = #{prs.process}, process_id = #{prs.process_id}, "
            ...
            + "need_decoct_alone = #{prs.need_decoct_alone}, decoct_alone_list = #{prs.decoct_alone_list, jdbcType=LONGVARCHAR}" + " where id = #{prs.id}")
