...
<h3 class="sub-header">接方流程列表<a class="btn btn-primary" style="float:right;margin-top:-5px" href="<%=request.getContextPath()%>/prescription/add">添加处方</a><a class="btn btn-success"
    style="float:right;margin-top:-5px" href="">打印处方标签</a></h3>
<div>
